...
public class Login extends JFrame {
	...
	public Login(){
		Font fnMono = new Font("Comic Sans MS",Font.PLAIN,15);
		...
		txtUname.setPreferredSize(new Dimension(100, 30));
		txtUname.setFont (new Font ("Comic Sans MS",Font.PLAIN, 20));
		
		txtPass  = new JPasswordField(15);
		txtPass.setPreferredSize(new Dimension(100, 30));
		txtPass.setFont (new Font ("Comic Sans MS",Font.PLAIN, 20));
		
		JLabel lblImg = new JLabel();
		lblImg.setIcon(new ImageIcon("img/Students.jpg")); ;		
		...
		sec.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.DARK_GRAY),"--| Member Login |--"));
