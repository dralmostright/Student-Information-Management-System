...
public class MainPanel extends JFrame{
	...
	public String[] txtLabels = {"Add Student","List Student","Add Class","List Class",
								...
								"Add Marks","List Results","Event Manger","Accounting"};
	public String[] imgs = {"add-student.png","list-student.png","add-class.png","list-class.png",
							...
							"add-marks.png","list-marks.png","calendar.png","account.png"};
	...
	public MainPanel(){
		...
		exitPanel.setBorder(BorderFactory.createEmptyBorder(0, 370, 5, 90));
		...
		sep.add(dashboard);
		sep.setBorder(BorderFactory.createEmptyBorder(50, 20, 50, 20));
		...
		mid.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(255,175,50), 1,true),"---| Dashbaoard |---",
				TitledBorder.CENTER, 0, new Font("Comic Sans MS",Font.PLAIN,12),new Color(255,175,50)));
